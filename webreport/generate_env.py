...
from bd_shared.config import (
    WEBREPORT_BACKEND_PORT,
    WEBREPORT_FRONTEND_PORT,
    WEBREPORT_DEBUG,
    WEBREPORT_RELOAD,
    WEBREPORT_BACKEND_DEBUG_PORT,
    WEBREPORT_FRONTEND_DEBUG_PORT,
    XLSM_FETCH_TIMEZONE,
)
...
WEBREPORT_RELOAD={str(WEBREPORT_RELOAD).lower()}
...
print(
    f"Generated .env file with ports: backend={WEBREPORT_BACKEND_PORT}, "
    f"frontend={WEBREPORT_FRONTEND_PORT}, timezone={XLSM_FETCH_TIMEZONE}, "
    f"debug={WEBREPORT_DEBUG}, reload={WEBREPORT_RELOAD}"
)
