...
**pref**: `dict` с ключами `I-VII, Goal, Points, Penalty, Bonus, Сумма` - правильный(1) или неправильный(0) ответ на каждое из 7 заданий + цель (ставкка на количество правильных ответов) + базовые очки, штрафы, бонусы, общая сумма очков
